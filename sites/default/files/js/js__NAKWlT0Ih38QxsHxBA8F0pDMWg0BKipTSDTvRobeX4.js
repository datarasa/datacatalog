...
(function($) {
  $(document).ready(function(){
    ...
    $('body.node-type-source .panels-flexible-region-9-center .inner').wrapAll( '<div class="src-clps" />');
	
    $('body.node-type-source .panels-flexible-region-9-center .src-clps').showMore({
      minheight: 59,
      animationspeed: 250
    });
