var d2 = [[1262304000000, 50], [1264982400000, 100], [1267401600000, 95], [1270080000000, 148], [1272672000000, 53], [1275350400000, 110], [1277942400000, 50], [1280620800000, 100], [1283299200000, 110], [1285891200000, 120], [1288569600000, 100], [1291161600000, 90]];
 
var data2 = [
    {label: "Trend",  data: d2, points: { symbol: "circle", fillColor: "#fff" , radius:4}, color: '#3c90cf',lines: {
        fill: true,
        lineWidth: 1,
        fillColor: {
...
$(document).ready(function () {
    ...
    function showTooltip(x, y, contents, z) {
        $('<div id="source-tooltip">' + contents + '</div>').css({
            top: y - 30,
            left: x - 135,
            'border-color': z,
    ...
    $("#sourceholder").bind("plothover", function (event, pos, item) {
        if (item) {
            if ((previousPoint != item.dataIndex) || (previousLabel != item.series.label)) {
                ...
                showTooltip(item.pageX, item.pageY,
                    /*"<b>" + item.series.label + "</b><br /> " + "Sources"+ " : <span class='source-nos'>" + y + "</span>",
                    z);*/
					"<b>" + ""+ "</b><br /> " + "Sources"+ " : <span class='source-nos'>" + y + "</span>",
                    z);
            }
        } else {
            $("#source-tooltip").remove();
