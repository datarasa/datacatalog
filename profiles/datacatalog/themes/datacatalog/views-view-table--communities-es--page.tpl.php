  ...
  <div class="pd-wrpr">
    <div class="wrapper">   
      <div id="img-wrapper" class="col-sm-3 col-md-3 col-xs-12 p-l-0 p-r-0">
        <div class="image"><?php if(isset($row["field_group_image"]) && $row["field_group_image"] != ""){ echo  $row["field_group_image"]; }else{ echo '<img src="/profiles/datacatalog/themes/datacatalog/images/dp_defualt.png">';}  ?></div>
      </div>
