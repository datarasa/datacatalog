...
if (isset($_REQUEST['ng_lightbox_path'])) {
  ...
  if (count($nodes) > 0) {
 ?>     
      <p>Attribute <?php echo $attribute; ?> exists in following Sources:<p>
     <ul>
 <?php        
  ...
  ?>          
         <li class="col-md-3 col-sm-4 col-xs-12"> <?php echo l($source->title, $alias); ?> </li>
 <?php           
          }
      }
    }
  ...
  <?php    
      ...
      ?>
      <p>Attribute <?php echo $attribute ?> not found in anyother Source<p>
 <?php         
  }
}
?>