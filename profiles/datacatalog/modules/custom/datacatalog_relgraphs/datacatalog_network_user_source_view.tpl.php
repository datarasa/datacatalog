...
if (isset($_POST['srch_key']) && $_POST['srch_key'] != "") { 
  ...
  $data = '{"statements":[{"statement":"MATCH a -[r:Created]- b Where a.name =  \''.$searchedKey.'\' RETURN r;","resultDataContents":["row","graph"],"includeStats":true}]};';
  $curl = curl_init();
...
<?php 
if(isset($result_decoded) and count($result_decoded->results[0]->data) > 0){ ?>
