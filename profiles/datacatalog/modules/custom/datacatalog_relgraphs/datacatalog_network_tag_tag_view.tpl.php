...
<input type="hidden" name="rel_type" id="rel_type" value="tg_tg" />
     <div>
...
if (isset($_POST['srch_key']) && $_POST['srch_key'] != "") { 
  ...
  $data = '{"statements":[{"statement":"MATCH (a:Tags)-[r:Source_Tags]-(b:Source)-[r2:Source_Tags]->(c:Tags) where a.name = \''.$searchedKey.'\' and c.name <> \''.$searchedKey.'\' RETURN r, r2;","resultDataContents":["row","graph"],"includeStats":true}]};';
  $curl = curl_init();
