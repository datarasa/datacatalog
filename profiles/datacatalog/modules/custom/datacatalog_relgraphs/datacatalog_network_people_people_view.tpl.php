...
<input type="hidden" name="rel_type" id="rel_type" value="people_people" />
     <div>
       <div class="form-item form-type-textfield">
        ...
        <input type="text" class="form-control form-text ui-autocomplete-input" maxlength="128" size="120" name="srch_key"  id="searchA" placeholder="Please enter Username to generate the graph" autocomplete="off" value="<?php echo $_POST["srch_key"];?>">
...
if (isset($_POST['srch_key']) && $_POST['srch_key'] != "") { 
  ...
  $data = '{"statements":[{"statement":"MATCH (a:User)-[r:Created]-(b:Source)-[r2:Owners]->(c:User) where a.name = \''.$searchedKey.'\' and c.name <> \''.  $searchedKey.'\' RETURN r, r2;","resultDataContents":["row","graph"],"includeStats":true}]};';
  $curl = curl_init();
