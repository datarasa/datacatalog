...
<input type="hidden" name="rel_type" id="rel_type" value="tg_ds" />
     <div>
...
if (isset($_POST['srch_key']) && $_POST['srch_key'] != "") { 
  ...
  $data = '{"statements":[{"statement":"MATCH (a:Tags)-[r:Source_Tags]-(b) Where a.name =  \''.$searchedKey.'\' RETURN r;","resultDataContents":["row","graph"],"includeStats":true}]};';
  $curl = curl_init();
