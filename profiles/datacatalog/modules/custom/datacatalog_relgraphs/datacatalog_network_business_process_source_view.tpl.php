...
<input type="hidden" name="rel_type" id="rel_type" value="bp_ds" />
     <div>
       <div class="form-item form-type-textfield">
        ...
        <input type="text" class="form-control form-text ui-autocomplete-input" maxlength="128" size="120" name="srch_key"  id="searchA" placeholder="Please enter Business Process to generate the graph" autocomplete="off" value="<?php echo $_POST["srch_key"];?>">
...
if (isset($_POST['srch_key']) && $_POST['srch_key'] != "") { 
  ...
  $data = '{"statements":[{"statement":"MATCH (a)-[r:Source_Business_Process]-(b) Where a.title =  \''.$searchedKey.'\' RETURN r;","resultDataContents":["row","graph"],"includeStats":true}]};';
  $curl = curl_init();
